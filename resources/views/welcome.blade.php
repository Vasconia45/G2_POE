...
<ul class="navbar-nav col-lg-2 col-md-3 col-4 flex-row justify-content-around">
    ...
    <li><a href="{{ route('mostrar_vuelos') }}" style="text-decoration: none"
                ...
                <div class="cards-wrapper d-flex justify-content-around">
                    <div class="cards">
                        <div class="face front">
                            <img src="{{ URL('assets/img/' . $categoria->nombre . '.jpg') }}" class="w-100 h-100"
                                valt="" />
                        </div>
                        <div class="face back">
                            @if (auth()->user())
            ...
            <div class="carousel-item">
                <div class="cards-wrapper d-flex justify-content-around">
                    <div class="cards">
                        <div class="face front">
                            @if (auth()->user())
                            <a href="#"><img src="{{ URL('assets/img/' . $categoria->nombre . '.jpg') }}"
                                    class="w-100 h-100" valt="" /></a>
                            @else
                            <a href="{{ route('register') }}"><img
                                    src="{{ URL('assets/img/' . $categoria->nombre . '.jpg') }}" class="w-100 h-100"
                                    valt="" /></a>
                            @endif
                        </div>
                        <div class="face back">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item active">
                <div class="cards-wrapper d-flex justify-content-around">
                    <div class="cards">
                        <div class="face front">
                            @if (auth()->user())
                            <a href="#"><img src="{{ URL('assets/img/' . $marca->nombre . '.jpg') }}"
                                    class="w-100 h-100" valt="" /></a>
                            @else
                            <a href="{{ route('register') }}"><img
                                    src="{{ URL('assets/img/' . $marca->nombre . '.jpg') }}" class="w-100 h-100"
                                    valt="" /></a>
                            @endif
                        </div>
                        <div class="face back">
            ...
            <div class="carousel-item">
                <div class="cards-wrapper d-flex justify-content-around">
                    <div class="cards">
                        <div class="face front">
                            <img src="{{ URL('assets/img/' . $marca->nombre . '.jpg') }}" class="w-100 h-100" valt="" />
                        </div>
                        <div class="face back">
                            @if (auth()->user())
                            <a href="#">
